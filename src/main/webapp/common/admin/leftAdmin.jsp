...
<div class="sidenav">
	...
	<div class="dropdown-container">
		<a href="${pageContext.request.contextPath}/admin/doanhThuTheoThu">
			<i class="fas fa-chart-pie fa-fw me-3"></i><span>Danh thu thứ</span>
		</a><a href="${pageContext.request.contextPath}/admin/doanhThuTheoThang">
	...
	<div class="dropdown-container">
		<a href="${pageContext.request.contextPath}/admin/managerAccount">
			<i class="fas fa-user-circle fa-fw me-3"></i><span>Quản lý tài
				khoản</span>
		</a> <a href="${pageContext.request.contextPath}/admin/manager"> <i
	...
	<div class="dropdown-container">
		<a href="${pageContext.request.contextPath}/admin/top10"> <i
			...
			<i class="fas fa-user-circle fa-fw me-3"></i><span>Top 5 nhân
				viên</span>
		</a>
	</div>
