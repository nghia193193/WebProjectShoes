		...
		<div class="classic-tabs">
			...
			<div class="tab-content" id="advancedTabContent">
				<div class="tab-pane fade show active" id="description"
					...
					<p class="pt-1" style="font-size: 15px">${detail.description}</p>
				</div>
				...
				<div class="tab-pane fade" id="reviews" role="tabpanel"
					...
					<h5 class="mt-4" style="font-size: 15px">Thêm nhận xét</h5>
					<p></p>
					...
					<div>
						...
						<div class="md-form md-outline">
							<textarea id="form76" class="md-textarea form-control pr-6"
								rows="4" style="font-size: 15px;"></textarea>
							...
							<c:forEach items="${listAllAcount}" var="a">
								<c:if test="${r.accountID == a.id }">
									...
									<c:if test="${a.image != null }">
										...
										<img class="d-flex mr-3 z-depth-1" src="${imgUrl}" width="62"
											height="62" style="border-radius: 50%"
											alt="Generic placeholder image">
									</c:if>
								</c:if>
							</c:forEach>
