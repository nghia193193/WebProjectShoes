...
public class InvoiceReceiveControler extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		invoiceServices.updateInvoice(iID, 3);

		List<InvoiceShop> listInvoiceShops = invoiceShopServices.getListInvoiceShopByOrderID(iID);
		for (InvoiceShop i : listInvoiceShops) {
			invoiceShopServices.updateInvoice(i.getMaHD(), 3);
		}
