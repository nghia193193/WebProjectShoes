...
public class OrderControl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String link = "http://localhost:8080/FinalProjectWeb/login/orderConfirm?maHD=" + invoiceDetailId.getMaHD();
			...
			sb.append("<button><a href = ' ").append(link).append(" '>Xác nhận đơn hàng này </a></button> ");
